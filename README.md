...
```sim.vcf ``` | Simulate SNPs and save as a VCF; optionally introduce missing data; optionally simulate locality data | [example.vcf.gz](inst/extdata/example.vcf.gz) (optional) | [simK2.vcf.gz](inst/extdata/simK2.vcf.gz); [simK2_coords.txt](inst/extdata/simK2_coords.txt); [simK2_coords_map.pdf](inst/extdata/simK2_coords_map.pdf)
