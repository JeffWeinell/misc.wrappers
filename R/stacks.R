...
#' 
#' For each set of samples (processed with populations and with vcf file generated for snps) this function creates a bash job file to calculate basic statistics.
#' 
