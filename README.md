...
```create.outer``` | [coords.txt](inst/extdata/createouter_exampleInput_coords.txt) | [method1_outer.text](inst/extdata/createouter_exampleOutput_method1_outer.text), [method1_outer.pdf](inst/extdata/createouter_exampleOutput_method1_outer.pdf), [method2_outer.text](inst/extdata/createouter_exampleOutput_method2_outer.text), [method2_outer.pdf](inst/extdata/createouter_exampleOutput_method2_outer.pdf), [method3_outer.text](inst/extdata/createouter_exampleOutput_method3_outer.text), [method3_outer.pdf](inst/extdata/createouter_exampleOutput_method3_outer.pdf)
```run_DAPC``` | | 
```run_sNMF``` | | 
```runtess``` | | 
```run_fastStructure```  |  | 
