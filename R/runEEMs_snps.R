...
#' @export runEEMs_snps
runEEMs_snps <- function(exe.path=NULL, input.data, coord, outer=NULL, ask.use.outer=T, output.dirpath, n.sites, ploidy=2, nDemes=300, numMCMCIter = 10000000, numBurnIter = 1000000, numThinIter = 9999, nchains=3, setup.only=T){
