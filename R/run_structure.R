...
#' @param xdir Optional path to the directory containing all STRUCTURE output files plus the '.*_sampleIDs.txt' file generated by run_structure. Default NULL. If supplied, this overides save.as, method, labels, and x arguments.
...
admixturePlots <- function(x, xdir=NULL,labels=NULL, method="structure", save.as=file.path(getwd(),"admixturePlots.pdf"), userun=1){
		if(!is.null(xdir)){
