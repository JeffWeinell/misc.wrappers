...
```run_DAPC``` | Pipeline for running DAPC and graphing results | [simK4.vcf.gz](inst/extdata/simK4.vcf.gz),<br/> [simK4_coords.txt](inst/extdata/simK4_coords.txt) (optional) | [DAPC_simK4_withCoords_v2_desnsityPlots_DF.pdf](inst/extdata/DAPC_simK4_withCoords_v2_desnsityPlots_DF.pdf) <br/>[DAPC_simK4_withCoords_v2.pdf](inst/extdata/DAPC_simK4_withCoords_v2.pdf) <br/>[DAPC_simK4_withCoords_v2_BiPlots.pdf](inst/extdata/DAPC_simK4_withCoords_v2_BiPlots.pdf) <br/>[DAPC_simK4_withCoords_v2_desnsityPlots_PC.pdf](inst/extdata/DAPC_simK4_withCoords_v2_desnsityPlots_PC.pdf)
